  ...
  return (
    <div className="shadow p-5 mb-3 flex gap-10 items-center">
      ...
      <div className="md:w-4/6">
        ...
        <p className="mt-2 font-black text-sm text-gray-600">
      ...
      <div>
        <button
          type="button"
          className="bg-sky-700 flex gap-2 px-5 py-2 text-white 
          rounded-md font-bold uppercase shadow-md w-full text-center"
        ...
        <button
          type="button"
          className="bg-red-700 flex gap-2 px-5 py-2 text-white 
          rounded-md font-bold uppercase shadow-md w-full mt-5 text-center"
